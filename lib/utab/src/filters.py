...
def prevent_str_wek_round(round_num, tournament, selected_grid_list, lattice_list, shift):
	true_grids_list1 = []
	true_grids_list2 = []
	true_grids_list3 = []
...
def rotation_allocation(round_num, tournament, selected_grid_list, lattice_list, shift):
	lattice_list_cp = copy.copy(lattice_list)
...
def avoid_watched_teams(round_num, tournament, selected_grid_list, lattice_list, shift):
	lattice_list_cp = copy.copy(lattice_list)
...
def prioritize_bubble_round(round_num, tournament, selected_grid_list, lattice_list, shift):
	if len(lattice_list[0].grid.teams) == 2:
		...
		may_be_breaking_wins = expected_wins_distribution[tournament.break_team_num-1]
...
def random_allocation(round_num, tournament, selected_grid_list, lattice_list, shift):
	lattice_list_cp = copy.copy(lattice_list)
